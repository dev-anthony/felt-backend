 ...
 *
 * The voice is that of an encroaching, clinical observer documenting an
 * inescapable truth: safety is the greatest deception, every sanctuary is
 * already a confinement cell, and stillness itself has become predatory.
 * Recurring vocabulary: surveillance, sanctuary, threshold, contamination,
 * observation, confinement, intrusion. Anchor and motionBias are
 * DEAM-calibrated and unchanged; only the twelve cells were rewritten.
 */
module.exports = {
  ...
  states: {
    normal: {
      ...
      high: 'The human form reduced to an object of intrusive observation, where the illusion of privacy collapses entirely. High-contrast flash creates a hard glare against absolute black as an extreme close-up captures a human profile pressed behind dirty glass, grease smudges evidence of repeated failed escape.',
      extreme: 'Space undergoing complete kinetic erasure, proving that total predictability can still inspire a deep, animalistic panic. High-velocity motion blur obliterates geometry into smeared colour tracks and deep shadow voids, structural data breaking down under a predatory storm of compression noise.',
    },
    luxury: {
      ...
      medium: 'Power isolated in a void, where wealth has quietly completed its transition into a solitary confinement cell. A single screen glows within an executive dark space, casting a cold terminal blue highlight against absolute leather black, empty boardroom chairs implying an invisible presence.',
    ...
    gritty: {
      low: 'A decaying urban infrastructure documenting a civilisation systematically entombed by its own architects. Corrupted sodium-vapour light stains a parking garage a toxic industrial orange over asphalt black, a distant CCTV framing proving that observation is indistinguishable from imprisonment.',
      ...
      high: 'A defensive gesture that only highlights vulnerability, turning a weapon of light into an instrument of absolute self-betrayal. A flashlight held under the chin bleaches skin tones and throws hard shadows upward off the jaw, an intimate, sweaty portrait of raw, unvarnished hyper-vigilance.',
