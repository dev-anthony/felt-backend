...
/** @type {Record<string, { suffix: string, dnaBias: Record<string, number>, graphic: string[] }>} */
const TECHNIQUES = {
  FLASH_DOCUMENTARY: {
    suffix: 'Raw black-and-white or high-contrast color 35mm flash photography. Young subject, direct harsh flash, authentic coarse film grain, raw visible skin texture, natural imperfections, flash glare. Concealed faces using props (e.g., Polaroid camera covering half the face).',
    dnaBias: { grit: +0.12, energy: +0.08 },
    graphic: ['graphic_clean_photo', 'graphic_parental_advisory']
  },
  VINTAGE_FILM_NOSTALGIA: {
    suffix: 'Vintage Print/Vinyl Layout aesthetic: Dual framed portraits on worn black cardstock cover, folded paper crease texture along edges, distressed print art, 90s Hip-Hop/Streetwear single cover vibe. Shot on real aged medium format analog camera.',
    dnaBias: { warmth: +0.12, acousticness: +0.08 },
    graphic: ['graphic_clean_photo', 'graphic_vinyl_sleeve']
  },
  SILHOUETTE_ATMOSPHERE: {
    suffix: 'High-contrast dark editorial shot, intense monochromatic red/green gel spotlighting, heavy shadows, silhouetted youth with raised hands. Shot on 35mm film, low-light ISO noise, dark mood, volumetric haze/smoke. The light source, not the face, is the subject.',
    dnaBias: { darkness: +0.12, intimacy: +0.05 },
    graphic: ['graphic_clean_photo']
  },
  SURREAL_PRACTICAL_METAPHOR: {
    suffix: 'High Surrealism grounded in Reality (e.g., Young male subject reading a burning newspaper). Photorealistic flame texture, direct flash lighting, cinematic warm shadow contrast. The impossible element is a real prop, physically built and shot in camera.',
    dnaBias: { darkness: +0.08, aggression: +0.06 },
    graphic: ['graphic_clean_photo']
  },
  DUOTONE_COLOR_WASH: {
    suffix: 'The colour lives in the emulsion of a real print, not a flat digital filter laid on top. Modern youth culture styling, stark red/black or moody gel duo-tone lighting. Authentic coarse film grain and low-light ISO noise.',
    dnaBias: { darkness: +0.10, intimacy: +0.06 },
    graphic: ['graphic_clean_photo']
  },
  MACRO_INTIMATE_DETAIL: {
    suffix: 'Uncomfortably close and completely unretouched. Raw visible skin texture, young modern subject, subtle motion blur, shot on medium format analog camera. Natural imperfections highlighted.',
    dnaBias: { intimacy: +0.15 },
    graphic: ['graphic_clean_photo']
  },
  MOTION_BLUR_STROBE: {
    suffix: 'The blur is a real long-exposure artifact of the moment, not an added effect. Dancing, mania, physical release in modern streetwear. Real film grain, motion blur, direct flash.',
    dnaBias: { motion: +0.15, danceability: +0.06 },
    graphic: ['graphic_clean_photo']
  },
  MIRROR_DOUBLE_EXPOSURE: {
    suffix: 'Both layers are one single in-camera exposure, not two images blended afterward. Duality, identity conflict. Shot on 35mm film, authentic material texture, edge-cut hairstyles visible in the silhouette.',
    dnaBias: { darkness: +0.06, intimacy: +0.06 },
    graphic: ['graphic_clean_photo']
  },
  STUDIO_SEAMLESS_EDITORIAL: {
    suffix: 'A real physical studio shoot, nothing retouched afterward. Fashion-forward Gen-Z / Millennial artist, leather corsets, futuristic sunglasses, streetwear jackets. High-end editorial photographic realism, zero CGI sheen.',
    dnaBias: { euphoria: +0.08, brightness: +0.06 },
    graphic: ['graphic_clean_photo', 'graphic_minimal_luxury']
  },
  MONUMENTAL_SCALE_ISOLATION: {
    suffix: 'Real atmospheric haze separates the layers of distance. Young fashionable figure isolated in scale. Shot on 35mm film, heavy grain, dark mood, volumetric haze/smoke, natural imperfections.',
    dnaBias: { darkness: +0.06, intimacy: +0.04, energy: -0.06 },
    graphic: ['graphic_clean_photo', 'graphic_minimal_luxury']
  },
}
